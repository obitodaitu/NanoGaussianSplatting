...
IMPLEMENT_GLOBAL_SHADER(FGaussianSplatCompositeVS, "/Plugin/GaussianSplatting/Private/GaussianSplatComposite.usf", "MainVS", SF_Vertex);
IMPLEMENT_GLOBAL_SHADER(FGaussianSplatCompositePS, "/Plugin/GaussianSplatting/Private/GaussianSplatComposite.usf", "MainPS", SF_Pixel);
